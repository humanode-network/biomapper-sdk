...
interface IBridgedBiomapperRead {
    ...
    /// @notice Describes a point in time (block number at the BridgingTxPoint chain) when a generation was bridged from Humanode chain.
    /// @dev Stored in a map where key is a block number at the BridgingTxPoint chain.
    ...
    /// @notice Describes a point in time (block number at the BridgingTxPoint chain) when a biomapping was bridged from Humanode chain.
    /// @dev Stored in a double map where the keys are an account and a block number at the BridgingTxPoint chain.
    ...
    /// @notice The newest `Biomapping` ptr for a given account.
    function biomappingsHead(address account) external view returns (uint256);

    /// @notice The oldest `Biomapping` ptr for a given account.
    function biomappingsTail(address account) external view returns (uint256);

    /// @notice Get `Biomapping` by ptr for a given account.
    ...
    /// @notice The newest `BiomappingsBridgingTxPoint` ptr for a given account.
    function biomappingsBridgingTxPointsHead(
        address account
    ) external view returns (uint256);

    /// @notice The oldest `BiomappingsBridgingTxPoint` ptr for a given account.
    function biomappingsBridgingTxPointsTail(
        address account
    ) external view returns (uint256);

    /// @notice Get `BiomappingsBridgingTxPoint` by ptr for a given account.
    ...
    /// @notice Get `Biomapping` ptr for a given account in a requested generation.
    ...
    /// @notice Get `BiomappingsBridgingTxPoint` ptr for a given account in a requested generation bridged tx point.
